...
const NavBar = () => {
  ...
  return (
    // sticky top-0 — scrolls with page until it hits the top, then sticks.
    // Does NOT overlap content below it (unlike fixed).
    <header
      className="sticky top-0 left-0 right-0 w-full z-50"
      style={{
    ...
    >
      <div className="w-full h-16 flex items-center justify-between px-4 sm:px-10">
        ...
        >
          <div className="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center flex-shrink-0 transition-all duration-200 group-hover:shadow-[0_0_14px_rgba(0,230,118,0.45)]">
        ...
        {/* ── Desktop nav links (hidden on mobile — AppNavBar handles mobile) ── */}
        ...
        <button
          ...
          className="group flex items-center justify-center w-9 h-9 rounded-xl border border-neutral-800 bg-neutral-900
                     hover:border-green-500/40 hover:bg-green-500/5 transition-all duration-200 outline-none"
          aria-label="Profile"
        >
          <CgProfile
            size={20}
